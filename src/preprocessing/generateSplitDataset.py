...
def main(config_path):
    ...
    buildDatasetFromShards(os.path.join(data_dir, "train_data"), training_files)
    buildDatasetFromShards(os.path.join(data_dir, "validation_data"), validation_files)
    buildDatasetFromShards(os.path.join(data_dir, "test_data"), testing_files)      
